...
topology = StorageTopology(num_nodes=4, num_objects=3, capacities=[1, 1, 1, 1], weights=latencies)
...
#Check if allocation is minimal with regard to both worst-case and average latency
